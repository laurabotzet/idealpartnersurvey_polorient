...
##### H1a Interest in Single Life {.tabset .active}
```{r}
...
##### H4a(1) Ideal Age (Importance) {.tabset}
```{r}
data_included_documented_rescon_wide = data_included_documented_rescon %>%
  pivot_wider(names_from = country, values_from = political_orientation) %>%
...
##### H4b(1) Ideal Height (Importance) {.tabset}
```{r}
data_included_documented_rescon_wide = data_included_documented_rescon %>%
  pivot_wider(names_from = country, values_from = political_orientation) %>%
...
##### H4b(2) Ideal Height (Level) {.tabset}
```{r}
data_included_documented_rescon_wide = data_included_documented_rescon %>%
  pivot_wider(names_from = country, values_from = political_orientation) %>%
