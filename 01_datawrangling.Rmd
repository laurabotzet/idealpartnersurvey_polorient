...
```{r Ideal Height}
table(fulldata_selected_lim_wrangled$ideal_height)

fulldata_selected_lim_wrangled = fulldata_selected_lim_wrangled %>%
  mutate(ideal_height = ifelse(ideal_height == "", NA, ideal_height),
         ideal_height_numeric = as.factor(ideal_height))

fulldata_selected_lim_wrangled$ideal_height_numeric = 
  recode(fulldata_selected_lim_wrangled$ideal_height_numeric,
...
crosstabs(~ideal_height_numeric + ideal_height, data = fulldata_selected_lim_wrangled)
table(fulldata_selected_lim_wrangled$ideal_height)
class(fulldata_selected_lim_wrangled$ideal_height_numeric)
levels(fulldata_selected_lim_wrangled$ideal_height_numeric)

fulldata_selected_lim_wrangled %>%
  select("ideal_height_numeric") %>%
  lapply(table)

qplot(fulldata_selected_lim_wrangled$ideal_height_numeric)
