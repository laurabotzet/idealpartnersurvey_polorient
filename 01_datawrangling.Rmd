...
Correct typo in variable pref_level_successful_ambitious
```{r Correct typo in variable pref_level_successful_ambitious}
fulldata_selected_wrangled <- rename(fulldata_selected_wrangled, pref_level_successful_ambitious= pref_level_successful_ambitous)
```

Correct typo in variable interest_monrel
```{r Correct typo in variable interest_monrel}
fulldata_selected_wrangled <- rename(fulldata_selected_wrangled, interest_monrel = inteterst_monrel)
```
...
### Problem With South Korea / Korea, South {.tabset}
```{r}
fulldata_selected_wrangled = fulldata_selected_wrangled %>%
