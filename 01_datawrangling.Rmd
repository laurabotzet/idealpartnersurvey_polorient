...
mutate(fulldata_selected_lim_wrangled, pref_level_kind-supportive <- rowMeans(pref_level_kind, pref_level_supportive, na.rm = TRUE))
#@Laura auch falsch

fulldata_selected_lim_wrangled %>% 
  mutate(pref_level_kind-supportive = mean(pref_level_kind, pref_level_supportive))
