...
fulldata_selected_wrangled = fulldata_selected_wrangled %>%
  rename(interest_monrel = inteterst_monrel)

#Correct typo in variable pref_level_successful_ambitious
fulldata_selected_wrangled = fulldata_selected_wrangled %>%
  rename(pref_level_successful_ambitious = pref_level_successful_ambitous)
```
...
lm(political_orientation ~ age, data = fulldata_selected_wrangled)
```
