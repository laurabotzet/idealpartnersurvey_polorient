...
qplot(data_included_documented$political_orientation)+
  labs(y = "Number of Participants", x = "Right-Wing Political Orientation")+
...
#### Save image
```{r}
jpeg("Hist_PO.jpeg", width = 1050, height = 700)
qplot
dev.off()
```
@PROBLEM Bild speichert nicht automatisch richtig ab, Bild ist weiß
