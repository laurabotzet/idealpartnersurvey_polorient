...
hist = ggplot(data=data_included_documented, aes(data_included_documented$political_orientation)) + 
  geom_histogram(col = "grey", binwidth = 0.5, center = 0) +
  labs(x = "Right-Wing Political Orientation", y = "Number of Participants")+
