...
lmer(pref_level_kind_supportive ~ political_orientation + (1+political_orientation|country),
    ...
    plot()
```
@PROBLEM @Laura Hier beim Plot kommmt dieselbe Warnmeldung wie oben bei den KI 
...
```
@PROBLEM @Laura Hier kommt wieder dieselbe Warnmeldung 
Es gab 50 oder mehr Warnungen (Anzeige der ersten 50 mit warnings())
...
```
@PROBLEM @Laura Bei beiden Fehlermeldung: Es gab 50 oder mehr Warnungen (Anzeige der ersten 50 mit warnings()
...
```
@PROBLEM @Laura Warnmeldung s. oben (Warnmeldung erscheint auch wenn Modell ohne random slope)
