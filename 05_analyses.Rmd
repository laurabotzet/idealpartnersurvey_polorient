...
###### Standardized Coefficients
```{r}
standardize_parameters(model_pref_politicalsim, method = "refit", ci = 0.997)
...
model_pref_level_kind_supportive <- lmer(pref_level_kind_supportive ~ political_orientation + (1|country), data = data_included_documented)
...
#Model failed to converge, drop random slope:
model_pref_level_intelligence_educated <- lmer(pref_level_intelligence_educated ~ political_orientation + (1|country), data = data_included_documented)
```
...
#Model failed to converge, drop random slope:
model_ideal_age_rel <- lmer(ideal_age_rel ~ political_orientation + (1|country), data = data_included_documented)
```
