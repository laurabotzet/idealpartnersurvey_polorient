...
all_models_interest$hypothesis = factor(
  rep(c("H1a) Interest in Single Life", "H1b) Interest in Sexual,\nNon-Romantic Relationships",
      ...
      2),
  levels = c("H1d) Interest in Monogamous Relationships",
             "H1c) Interest in Non-Monogamous Relationships",
...
#Model for exact values of preferred political similarity
...
ggplot(data = data_included_nomiss_politicalsim,
  ...
  apatheme +
  labs(y = "Preferred Political Similarity", x = "Right-Wing Political Orientation")+
 ...
 scale_y_continuous(breaks=c(0, 1, 2, 3, 4, 5, 6)) 
  #theme(legend.position = c(0.95, 0.95), 
   #     legend.justification = c ("right", "top"), 
    ...
    #scale_fill_identity(guide = 'legend',labels = c('99.7% CI')) +
  #  scale_colour_manual(
     #    values =c('#084594'='#084594'), labels = c('Mean'))
...
ggplot(data = data_included_nomiss_politicalsim,
  ...
  stat_summary(geom="point", fun=mean, color="#084594") +
  apatheme +
  labs(y = "Preferred Political Similarity \n(Predicted Values)", x = "Right-Wing Political Orientation")+
 scale_x_continuous(breaks=c(0, 1, 2, 3, 4, 5, 6))+
 scale_y_continuous(breaks=c(0, 1, 2, 3, 4, 5, 6))
```
...
### Robustness Analyses
```{r}
#Model for exact values of preferred political similarity (RA)
model_pref_politicalsim_robustcheck = lmer(pref_politicalsim ~ political_orientation + I(political_orientation^2) + age +
                                 (1+political_orientation|country),
                               data = data_included_nomiss_politicalsim)

#Model for predicted values of preferred political similarity (RA)???
model_pref_politicalsim_pred_robustcheck = predict(model_pref_politicalsim)
