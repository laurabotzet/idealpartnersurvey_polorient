...
## Exclusion Process for Analyses Based on Homosexual Participants
```{r Exclusion Process}
...
### All participants who do not identify as homosexual
In total, we will exclude `r sum(fulldata_selected_wrangled$sexual_orientation == "Straight/Heterosexual", fulldata_selected_wrangled$sexual_orientation == "Queer", fulldata_selected_wrangled$sexual_orientation == "Asexual", fulldata_selected_wrangled$sexual_orientation == "Prefer not to say", fulldata_selected_wrangled$sexual_orientation == "Other", fulldata_selected_wrangled$sexual_orientation == "Bisexual/Pansexual", na.rm = T)` participants because they did not identify as homosexual.

Consecutively, this means we will exclude `r sum(data_included$sexual_orientation == "Straight/Heterosexual", data_included$sexual_orientation == "Queer", data_included$sexual_orientation == "Asexual", data_included$sexual_orientation == "Prefer not to say", data_included$sexual_orientation == "Other", data_included$sexual_orientation == "Bisexual/Pansexual", na.rm = T)` participants because they did not identify as homosexual.
```{r Sexuality}
data_included = data_included %>%
  filter((sexual_orientation != "Straight/Heterosexual" &
            sexual_orientation != "Bisexual/Pansexual" &
...
### Save Data
```{r Save Data}
write.csv(data_included, file = "data_included_exploratory_homosexuals.csv")
```

## Exclusion Process for Analyses Based on Bisexual Participants
```{r Exclusion Process 2}
data_included = fulldata_selected_wrangled
```
...
### All participants who do not identify as bisexual
In total, we will exclude `r sum(fulldata_selected_wrangled$sexual_orientation == "Straight/Heterosexual", fulldata_selected_wrangled$sexual_orientation == "Queer", fulldata_selected_wrangled$sexual_orientation == "Asexual", fulldata_selected_wrangled$sexual_orientation == "Prefer not to say", fulldata_selected_wrangled$sexual_orientation == "Other", fulldata_selected_wrangled$sexual_orientation == "Lesbian/Gay/Homosexual", na.rm = T)` participants because they did not identify as homosexual.

Consecutively, this means we will exclude `r sum(data_included$sexual_orientation == "Straight/Heterosexual", data_included$sexual_orientation == "Queer", data_included$sexual_orientation == "Asexual", data_included$sexual_orientation == "Prefer not to say", data_included$sexual_orientation == "Other", data_included$sexual_orientation == "Lesbian/Gay/Homosexual", na.rm = T)` participants because they did not identify as homosexual.
```{r Sexuality 2}
data_included = data_included %>%
  filter((sexual_orientation != "Straight/Heterosexual" &
            sexual_orientation != "Lesbian/Gay/Homosexual" &
         sexual_orientation != "Queer" & sexual_orientation != "Asexual" &
         sexual_orientation != "Prefer not to say" & sexual_orientation != "Other") |
         is.na(sexual_orientation))
...
## Save Data
```{r Save Data 2}
write.csv(data_included, file = "data_included_exploratory_bisexuals.csv")
```
