...
### Combine Graph Two
```{r}
data_graph2 = rbind(models_pref_level_financially_secure_successful_ambitious_graph) %>%
  mutate(outcome = factor(outcome,
